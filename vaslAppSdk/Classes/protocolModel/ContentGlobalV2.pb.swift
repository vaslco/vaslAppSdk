...
public struct Com_Vasl_Vaslapp_Modules_Content_Global_Proto_Holder_ContentInfo {
  ...
  public var catIds: [String] {
    get {return _storage._catIds}
    set {_uniqueStorage()._catIds = newValue}
  }
...
extension Com_Vasl_Vaslapp_Modules_Content_Global_Proto_Holder_ContentInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeRepeatedStringField(value: &_storage._catIds)
        ...
        case 13: try decoder.decodeSingularDoubleField(value: &_storage._rating)
        case 14: try decoder.decodeSingularInt64Field(value: &_storage._commentCount)
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._catIds.isEmpty {
        try visitor.visitRepeatedStringField(value: _storage._catIds, fieldNumber: 3)
      }
      ...
      if _storage._commentCount != 0 {
        try visitor.visitSingularInt64Field(value: _storage._commentCount, fieldNumber: 14)
      }
  ...
  public static func ==(lhs: Com_Vasl_Vaslapp_Modules_Content_Global_Proto_Holder_ContentInfo, rhs: Com_Vasl_Vaslapp_Modules_Content_Global_Proto_Holder_ContentInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._catIds != rhs_storage._catIds {return false}

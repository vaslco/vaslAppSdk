...
public struct Com_Vasl_Vaslapp_Modules_Billing_Global_Proto_Holder_Transaction {
  ...
  public var accoundID: String = String()
  ...
  public var paymentSuccessTime: String = String()
  ...
  public var ipgTransaction: Com_Vasl_Vaslapp_Modules_Billing_Global_Proto_Holder_IpgTransaction {
    get {return _ipgTransaction ?? Com_Vasl_Vaslapp_Modules_Billing_Global_Proto_Holder_IpgTransaction()}
    set {_ipgTransaction = newValue}
  }
  /// Returns true if `ipgTransaction` has been explicitly set.
  public var hasIpgTransaction: Bool {return self._ipgTransaction != nil}
  /// Clears the value of `ipgTransaction`. Subsequent reads from it will return its default value.
  public mutating func clearIpgTransaction() {self._ipgTransaction = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _ipgTransaction: Com_Vasl_Vaslapp_Modules_Billing_Global_Proto_Holder_IpgTransaction? = nil
}
...
extension Com_Vasl_Vaslapp_Modules_Billing_Global_Proto_Holder_Transaction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self.accoundID)
      case 3: try decoder.decodeSingularStringField(value: &self.ipgTransactionID)
      ...
      case 12: try decoder.decodeSingularStringField(value: &self.insertTime)
      case 13: try decoder.decodeSingularStringField(value: &self.paymentSuccessTime)
      case 14: try decoder.decodeSingularStringField(value: &self.orderID)
      case 16: try decoder.decodeSingularStringField(value: &self.packageID)
      case 17: try decoder.decodeSingularStringField(value: &self.type)
      case 18: try decoder.decodeSingularMessageField(value: &self._ipgTransaction)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.accoundID.isEmpty {
      try visitor.visitSingularStringField(value: self.accoundID, fieldNumber: 2)
    }
    if !self.ipgTransactionID.isEmpty {
      try visitor.visitSingularStringField(value: self.ipgTransactionID, fieldNumber: 3)
    }
    if self.amount != 0 {
    ...
    if !self.paymentSuccessTime.isEmpty {
      try visitor.visitSingularStringField(value: self.paymentSuccessTime, fieldNumber: 13)
    }
    if !self.orderID.isEmpty {
      try visitor.visitSingularStringField(value: self.orderID, fieldNumber: 14)
    }
    if !self.packageID.isEmpty {
      try visitor.visitSingularStringField(value: self.packageID, fieldNumber: 16)
    }
    if !self.type.isEmpty {
      try visitor.visitSingularStringField(value: self.type, fieldNumber: 17)
    }
    if let v = self._ipgTransaction {
  ...
  public static func ==(lhs: Com_Vasl_Vaslapp_Modules_Billing_Global_Proto_Holder_Transaction, rhs: Com_Vasl_Vaslapp_Modules_Billing_Global_Proto_Holder_Transaction) -> Bool {
    ...
    if lhs.accoundID != rhs.accoundID {return false}
    if lhs.ipgTransactionID != rhs.ipgTransactionID {return false}
    if lhs.amount != rhs.amount {return false}
    if lhs.status != rhs.status {return false}
    if lhs.description_p != rhs.description_p {return false}
    if lhs.insertTime != rhs.insertTime {return false}
    if lhs.paymentSuccessTime != rhs.paymentSuccessTime {return false}
    if lhs.orderID != rhs.orderID {return false}
    if lhs.packageID != rhs.packageID {return false}
    if lhs.type != rhs.type {return false}
    if lhs._ipgTransaction != rhs._ipgTransaction {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

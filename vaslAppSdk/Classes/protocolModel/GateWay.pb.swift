  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularStringField(value: &_storage._bankName)
        case 3: try decoder.decodeSingularStringField(value: &_storage._bankPerName)
        case 4: try decoder.decodeSingularMessageField(value: &_storage._images)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._bankName.isEmpty {
        try visitor.visitSingularStringField(value: _storage._bankName, fieldNumber: 2)
      }
      if !_storage._bankPerName.isEmpty {
        try visitor.visitSingularStringField(value: _storage._bankPerName, fieldNumber: 3)
      }

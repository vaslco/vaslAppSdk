...
public struct Com_Vasl_Vaslapp_Modules_Engagement_Channels_Global_Proto_Holder_ChannelList {
  ...
  public var page: Com_Vasl_Vaslapp_Modules_Engagement_Channels_Global_Proto_Holder_Page {
    get {return _storage._page ?? Com_Vasl_Vaslapp_Modules_Engagement_Channels_Global_Proto_Holder_Page()}
...
extension Com_Vasl_Vaslapp_Modules_Engagement_Channels_Global_Proto_Holder_ChannelList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _code: Int32 = 0
    var _msg: String = String()
    var _data: [Com_Vasl_Vaslapp_Modules_Engagement_Channels_Global_Proto_Holder_channel] = []
    var _page: Com_Vasl_Vaslapp_Modules_Engagement_Channels_Global_Proto_Holder_Page? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularInt32Field(value: &_storage._code)
        case 3: try decoder.decodeSingularStringField(value: &_storage._msg)
        case 4: try decoder.decodeRepeatedMessageField(value: &_storage._data)
        case 5: try decoder.decodeSingularMessageField(value: &_storage._page)
        default: break
        }
      }
    }

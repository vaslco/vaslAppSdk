...
protocol GatewayServiceV1 {
    ...
    func checkTransaction(transactionId: String, sessionId: String,completion : @escaping (Com_Vasl_Vaslapp_Modules_Bankgateway_Global_Proto_Holder_ConfirmTransaction?,String?) -> Void)
...
public class GatewayServiceV1Impl  : GatewayServiceV1 {
    ...
    public func checkTransaction(transactionId: String, sessionId: String,completion: @escaping (Com_Vasl_Vaslapp_Modules_Bankgateway_Global_Proto_Holder_ConfirmTransaction?,String?) -> Void) {
        checkTransaction(transactionId: transactionId, sessionId: sessionId, completion: completion,force: true)
    }
    
    private func checkTransaction(transactionId: String, sessionId: String,completion: @escaping (Com_Vasl_Vaslapp_Modules_Bankgateway_Global_Proto_Holder_ConfirmTransaction?,String?) -> Void,force : Bool) {
        var params = Dictionary<String,String>()
                    params.updateValue(transactionId            , forKey: "transactionId")
                    params.updateValue(sessionId            , forKey: "sessionId")

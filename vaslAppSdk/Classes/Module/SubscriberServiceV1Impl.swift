...
protocol SubscriberServiceV1 {
    ...
    func getOneTimePass(email: String,completion : @escaping (Com_Vasl_Vaslapp_Modules_Subscriber_Global_Proto_Holder_ForgotPassword?,String?) -> Void)
    ...
    func mobileconnectClientCreate(mobile: String, first_name: String, last_name: String, email: String, national_id: String, password: String, clientName: String, sessionId: String,completion : @escaping (Com_Vasl_Vaslapp_Modules_Subscriber_Global_Proto_Holder_ClientCreate?,String?) -> Void)
...
public class SubscriberServiceV1Impl  : SubscriberServiceV1 {
    ...
    public func getOneTimePass(email: String,completion: @escaping (Com_Vasl_Vaslapp_Modules_Subscriber_Global_Proto_Holder_ForgotPassword?,String?) -> Void) {
        getOneTimePass(email: email, completion: completion,force: true)
    }
    
    private func getOneTimePass(email: String,completion: @escaping (Com_Vasl_Vaslapp_Modules_Subscriber_Global_Proto_Holder_ForgotPassword?,String?) -> Void,force : Bool) {
        var params = Dictionary<String,Any>()
                    params.updateValue(email            , forKey: "email")
            ...
            do{
                if let result = result {
                    ...
                    if serviceResponse.status == PublicValue.status_success {
                        ...
                        if serviceResponse.code == 401 && force {
                            self.getOneTimePass(email: email, completion: completion,force: false)
                        }else{
                            completion(serviceResponse,serviceResponse.msg)
                        }
                    }
    ...
    public func mobileconnectClientCreate(mobile: String, first_name: String, last_name: String, email: String, national_id: String, password: String, clientName: String, sessionId: String,completion: @escaping (Com_Vasl_Vaslapp_Modules_Subscriber_Global_Proto_Holder_ClientCreate?,String?) -> Void) {
        mobileconnectClientCreate(mobile: mobile, first_name: first_name, last_name: last_name, email: email, national_id: national_id, password: password, clientName: clientName, sessionId: sessionId, completion: completion,force: true)
    }
            ...
            do{
                if let result = result {
                    ...
                    if serviceResponse.status == PublicValue.status_success {
                        ...
                        if serviceResponse.code == 401 && force {
                            self.mobileconnectClientCreate(mobile: mobile, first_name: first_name, last_name: last_name, email: email, national_id: national_id, password: password, clientName: clientName, sessionId: sessionId, completion: completion,force: false)
                        }else{
                            completion(serviceResponse,serviceResponse.msg)
                        }
                    }

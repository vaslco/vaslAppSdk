...
protocol HambaziServiceV1 {
    ...
    func subscriberList(subscriberType: String, sort: String, order: String, page: String,completion : @escaping (Com_Vasl_Vaslapp_Products_Hambazi_Proto_Holder_SubscriberList?,String?) -> Void)
    ...
    func subscriberUpdate(nickName: String, firstName: String, lastName: String, image: String, gender: String, birthDate: String, email: String,completion : @escaping (Com_Vasl_Vaslapp_Products_Hambazi_Proto_Holder_SubscriberUpdate?,String?) -> Void)
    ...
    func videoCreate(multipartFile: String, title: String, description: String, actors: String, categories: String, onlineShopPrice: String, actorVideoId: String, coverUrl: String, scenarioUrl: String, sessionId: String,completion : @escaping (Com_Vasl_Vaslapp_Products_Hambazi_Proto_Holder_VideoCreate?,String?) -> Void)
...
public class HambaziServiceV1Impl  : HambaziServiceV1 {
    ...
    public func subscriberList(subscriberType: String, sort: String, order: String, page: String,completion: @escaping (Com_Vasl_Vaslapp_Products_Hambazi_Proto_Holder_SubscriberList?,String?) -> Void) {
        subscriberList(subscriberType: subscriberType, sort: sort, order: order, page: page, completion: completion,force: true)
    }
    
    private func subscriberList(subscriberType: String, sort: String, order: String, page: String,completion: @escaping (Com_Vasl_Vaslapp_Products_Hambazi_Proto_Holder_SubscriberList?,String?) -> Void,force : Bool) {
        var params = Dictionary<String,String>()
            ...
            do{
                if let result = result {
                    ...
                    if serviceResponse.status == PublicValue.status_success {
                        ...
                        if serviceResponse.code == 401 && force {
                            self.subscriberList(subscriberType: subscriberType, sort: sort, order: order, page: page, completion: completion,force: false)
                        }else{
                            completion(serviceResponse,serviceResponse.msg)
                        }
                    }
    ...
    public func subscriberUpdate(nickName: String, firstName: String, lastName: String, image: String, gender: String, birthDate: String, email: String,completion: @escaping (Com_Vasl_Vaslapp_Products_Hambazi_Proto_Holder_SubscriberUpdate?,String?) -> Void) {
    ...
    private func subscriberUpdate(nickName: String, firstName: String, lastName: String, image: String, gender: String, birthDate: String, email: String,completion: @escaping (Com_Vasl_Vaslapp_Products_Hambazi_Proto_Holder_SubscriberUpdate?,String?) -> Void,force : Bool) {
        var params = Dictionary<String,String>()
        ...
        RestService.post(url: PublicValue.getUrlBase() + "/api/v1/hambazi/subscriber/update", params, completion: { (result, error) in
            do{
                if let result = result {
    ...
    public func videoCreate(multipartFile: String, title: String, description: String, actors: String, categories: String, onlineShopPrice: String, actorVideoId: String, coverUrl: String, scenarioUrl: String, sessionId: String,completion: @escaping (Com_Vasl_Vaslapp_Products_Hambazi_Proto_Holder_VideoCreate?,String?) -> Void) {
        videoCreate(multipartFile: multipartFile, title: title, description: description, actors: actors, categories: categories, onlineShopPrice: onlineShopPrice, actorVideoId: actorVideoId, coverUrl: coverUrl, scenarioUrl: scenarioUrl, sessionId: sessionId, completion: completion,force: true)
    }
    
    private func videoCreate(multipartFile: String, title: String, description: String, actors: String, categories: String, onlineShopPrice: String, actorVideoId: String, coverUrl: String, scenarioUrl: String, sessionId: String,completion: @escaping (Com_Vasl_Vaslapp_Products_Hambazi_Proto_Holder_VideoCreate?,String?) -> Void,force : Bool) {
        var params = Dictionary<String,String>()
                    params.updateValue(title            , forKey: "title")
                    params.updateValue(description            , forKey: "description")
                    params.updateValue(actors            , forKey: "actors")
                    params.updateValue(categories            , forKey: "categories")
                    params.updateValue(onlineShopPrice            , forKey: "onlineShopPrice")
                    params.updateValue(actorVideoId            , forKey: "actorVideoId")
                    params.updateValue(coverUrl            , forKey: "coverUrl")
                    params.updateValue(scenarioUrl            , forKey: "scenarioUrl")
                    params.updateValue(sessionId            , forKey: "sessionId")
        RestService.post(url: PublicValue.getUrlBase() + "/api/v1/hambazi/video/create", params, completion: { (result, error) in
            do{
                if let result = result {
                    ...
                    if serviceResponse.status == PublicValue.status_success {
                        ...
                        if serviceResponse.code == 401 && force {
                            self.videoCreate(multipartFile: multipartFile, title: title, description: description, actors: actors, categories: categories, onlineShopPrice: onlineShopPrice, actorVideoId: actorVideoId, coverUrl: coverUrl, scenarioUrl: scenarioUrl, sessionId: sessionId, completion: completion,force: false)
                        }else{
                            completion(serviceResponse,serviceResponse.msg)
                        }
                    }
